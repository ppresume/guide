...
This guide will systematically explain the essentials of resume writing and typesetting with paticular emphasis on typography, helping you make a resume pretty both in form and spirit. For each topic, it will first explain WHAT it is, then WHY is it so, and finally How to do it.

The guide is trying to be as concise and clear as possible, for different items there are four levels of priority:
- Must, mandatory in typesetting, serious mistake to violate
- Recommend, conform to general typesetting standard, highly recommended
...
- Forbidden, conflict with general typesetting standards, never applied
